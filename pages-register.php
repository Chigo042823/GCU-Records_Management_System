...
register($servername, $username, $password, $dbname);
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    <div class="d-flex justify-content-center py-4">
                      <a href="index.php" class="">
                        <img src="assets/img/pshslogo.png" alt="" height="220vh">
                      </a>
                    </div><!-- End Logo -->
                  ...
                  <form class="row g-3 needs-validation" novalidate method="POST" action="#">
                    ...
                    <div class="col-12">
                      <label for="yourEmail" class="form-label">Enter Your Username</label>
                      <input type="text" name="username" class="form-control" id="yourEmail" required>
                      <div class="invalid-feedback">Please enter your name</div>
                    </div>
                    <div class="col-12">
                      <label for="yourEmail" class="form-label">Enter Your Email</label>
